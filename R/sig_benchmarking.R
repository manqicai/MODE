...
sig_benchmarking <- function(sig){
  ...
  res_sig_gui <- EnsDeconv_wrap(B = B,frac_true = fractrue,
                             include_minfi = TRUE, sig = sig[intersect(rownames(sig),rownames(B)),])
  ...
  return(list(res_sig_gse= res_sig_gse,res_sig_gui = res_sig_gui,res_sig_gas = res_sig_gas))
}
