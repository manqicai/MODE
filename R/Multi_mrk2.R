#' Multi_mrk2 is used to generate dataframe that saved the multi-markers, it combines DM, DE and eQTM first
#'
...
#'
#' @examples
Multi_mrk2 <- function(DM_df = DM_df,eQTM_df = eQTM_df,DE_df = DE_df,padjust_method = "bonferroni",
